...
desenhaLoja loja ts = Pictures [iconeLoja, 
    ...
    where x = -805
          ...
          gelo = Translate (-805) 160 $ scale 1 1 $ fromJust $ lookup "gelo" ts
          resina = Translate (-805) (-40) $ scale 1 1 $ fromJust $ lookup "resina" ts
          fogo = Translate (-805) (-240) $ scale 1 1 $ fromJust $ lookup "fogo" ts
