...
itInicial texturas = ImmutableTowers { 
  jogoIT = Jogo {
        ...
        torresJogo = [Torre {posicaoTorre = (-5.5*64, -5.5*64), projetilTorre = Projetil {tipoProjetil = Gelo,duracaoProjetil = Finita 10}, danoTorre = 10,
                             alcanceTorre = 5*64,
                             rajadaTorre = 3,
                             cicloTorre = 2,
                             tempoTorre = 0}, 
                      Torre {posicaoTorre = (-4.5*64, 4.5*64), projetilTorre = Projetil {tipoProjetil = Resina, duracaoProjetil = Infinita}, danoTorre = 10,
                             alcanceTorre = 5*64,
                             rajadaTorre = 3,
                             cicloTorre = 2,
                             tempoTorre = 0}, 
                      Torre {posicaoTorre = (6.5*64, 0.5*64), projetilTorre = Projetil {tipoProjetil = Fogo, duracaoProjetil = Finita 5}, danoTorre = 10,
                             alcanceTorre = 5*64,
                             rajadaTorre = 3,
                             cicloTorre = 2,
                             tempoTorre = 0}],
