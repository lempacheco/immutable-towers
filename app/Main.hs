  ...
  jogoIT = Jogo {
        ...
        torresJogo = [Torre {posicaoTorre = (-5.5*64, -5.5*64), projetilTorre = Projetil {tipoProjetil = Gelo,duracaoProjetil = Finita 10}, danoTorre = 4,
                      ...
                      Torre {posicaoTorre = (6.5*64, 0.5*64), projetilTorre = Projetil {tipoProjetil = Fogo, duracaoProjetil = Finita 5}, danoTorre = 4,
                             ...
                             tempoTorre = 0}],
        portaisJogo = [
                        Portal {posicaoPortal = (-(7.5*64),-(1.5*64)), ondasPortal = [Onda {inimigosOnda = [Inimigo {posicaoInimigo = (-((7.5)*64),-((1.5)*64)), tipoInimigo = GuerreiroFogo, projeteisInimigo = [], vidaInimigo = 6, butimInimigo = 4, direcaoInimigo = Este, ataqueInimigo = 5, velocidadeInimigo = 50}],
                                cicloOnda = 2*60,
                                tempoOnda = 0,
                                entradaOnda = 0}]}
