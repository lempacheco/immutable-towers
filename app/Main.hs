...
main = do
  ...
  perfilGuerreiro <- loadBMP "resources/textures/entities/guerreiro_jogador.bmp"
  perfilViking <- loadBMP "resources/textures/entities/viking_jogador.bmp"
  perfilMulherLanca <- loadBMP "resources/textures/entities/mulherLanca_jogador.bmp"
  ...
  fundoMenu <- loadBMP "resources/textures/ui/fundoMenu.bmp"
  botaoPlay <- loadBMP "resources/textures/ui/botaoPlay.bmp"
  ...
  molduraMapa <- loadBMP "resources/textures/ui/molduraArbusto.bmp"
  ...
  tutorial1 <- loadBMP "resources/textures/ui/tutorial1.bmp"
  tutorial2 <- loadBMP "resources/textures/ui/tutorial2.bmp"
  tutorial3 <- loadBMP "resources/textures/ui/tutorial3.bmp"
  ...
  fundoPedraTT <- loadBMP "resources/textures/ui/fundoPedraTT.bmp"
  ...
  menuCustomize <- loadBMP "resources/textures/ui/menuCustomize.bmp"
